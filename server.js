...
app.get(['/', '/login', '/signUp', '/forgotPassword', '/dashboard', '/suggest-movie', '/favorites', '/movies', '/profile', '/admin', '/add-categories', '/add-movies', '/suggested-movies', '/view-grades', '/admin-profile'], function ( req, res ) {
